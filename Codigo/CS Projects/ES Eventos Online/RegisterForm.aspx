<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RegisterForm.aspx.cs" Inherits="ES_Eventos_Online.RegisterLogin" %>
...
<body style="background-color: #34495e;height:auto;font-family: 'Roboto Medium'">
    <form id="RegisterForm" runat="server" style="text-align:center">
        ...
        <div style="margin-top:30px;margin-bottom:50px">
            ...
            <h2 id="registerLbl" style=" font-size: 60px;color: #FFFFFF">Registro</h2>
        </div>
        <div>
            <asp:Label ID="nombreLbl" runat="server" Text="Nombre" style="font-family: 'Roboto Medium'; font-size: 40px;color: #FFFFFF"></asp:Label>
            <br />
                <asp:TextBox ID="nombreInput" runat="server" Width="170px" Height="20px" style="margin-bottom:20px"></asp:TextBox>
            <br />
                <span class="auto-style1">Número de cédula</span><br />
                <asp:TextBox ID="NumCedulaInput" runat="server" Width="170px" Height="20px" style="margin-bottom:20px"></asp:TextBox>
            <br />
            ...
            <br />
                <asp:TextBox ID="correoElectronicoInput" runat="server" Width="170px" Height="20px" style="margin-bottom:20px"></asp:TextBox>
            <br />
            ...
            <br />
                <asp:TextBox ID="UsernameInput" runat="server" Width="170px" Height="20px" style="margin-bottom:20px"></asp:TextBox>
            <br />
